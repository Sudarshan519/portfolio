...
Revision ID: d4967ccb61ad
Revises: cfa1189221bb
Create Date: 2023-06-29 16:20:10.940875
...
revision = 'd4967ccb61ad'
down_revision = 'cfa1189221bb'
branch_labels = None
depends_on = None
...
def downgrade() -> None:
    ...
    sa.Column('id', sa.INTEGER(), server_default=sa.text("nextval('breakmodel_id_seq'::regclass)"), autoincrement=True, nullable=False),
    ...
    sa.ForeignKeyConstraint(['company_id'], ['employeemodel.id'], name='breakmodel_company_id_fkey'),
    ...
    sa.Column('company_id', sa.INTEGER(), autoincrement=False, nullable=True),
    sa.ForeignKeyConstraint(['company_id'], ['companymodel.id'], name='employeemodel_company_id_fkey'),
    ...
    sa.Column('buy', sa.DOUBLE_PRECISION(precision=53), autoincrement=False, nullable=False),
    sa.Column('sell', sa.DOUBLE_PRECISION(precision=53), autoincrement=False, nullable=False),
    ...
    sa.Column('login_time', postgresql.TIME(), autoincrement=False, nullable=True),
    sa.Column('breaks', sa.INTEGER(), autoincrement=False, nullable=True),
    sa.Column('company_id', sa.INTEGER(), autoincrement=False, nullable=True),
    sa.Column('employee_id', sa.INTEGER(), autoincrement=False, nullable=True),
    sa.ForeignKeyConstraint(['breaks'], ['breakmodel.id'], name='attendancemodel_breaks_fkey'),
    sa.ForeignKeyConstraint(['company_id'], ['companymodel.id'], name='attendancemodel_company_id_fkey'),
    sa.ForeignKeyConstraint(['employee_id'], ['employeemodel.id'], name='attendancemodel_employee_id_fkey'),
