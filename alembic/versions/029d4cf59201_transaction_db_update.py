...
Revision ID: 029d4cf59201
Revises: 005cf09e1697
Create Date: 2023-09-06 22:11:31.593124
...
revision = '029d4cf59201'
down_revision = '005cf09e1697'
branch_labels = None
depends_on = None
...
def downgrade() -> None:
    ...
    sa.ForeignKeyConstraint(['companyid'], ['companymodel.id'], name='governmentleavedates_companyid_fkey'),
    sa.PrimaryKeyConstraint('id', name='governmentleavedates_pkey')
    )
    op.create_index('ix_governmentleavedates_id', 'governmentleavedates', ['id'], unique=False)
    ...
    sa.Column('leave_type', postgresql.ENUM('FESTIVAL', 'SICK', 'OTHER', name='leaverequesttype'), autoincrement=False, nullable=True),
    sa.Column('leave_day_type', postgresql.ENUM('FULLDAY', 'HALFDAY', name='leavedaytype'), autoincrement=False, nullable=True),
    ...
    sa.Column('status', postgresql.ENUM('INIT', 'ACCEPTED', 'REJECTED', name='leaverequeststatus'), autoincrement=False, nullable=True),
    sa.ForeignKeyConstraint(['company_id'], ['companymodel.id'], name='leaverequest_company_id_fkey', ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['employee_id'], ['employeemodel.id'], name='leaverequest_employee_id_fkey', ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id', name='leaverequest_pkey')
    )
    ...
    sa.Column('id', sa.INTEGER(), server_default=sa.text("nextval('attendancemodel_id_seq'::regclass)"), autoincrement=True, nullable=False),
    sa.Column('attendance_date', sa.DATE(), autoincrement=False, nullable=True),
    sa.Column('login_time', postgresql.TIME(), autoincrement=False, nullable=False),
    sa.Column('company_id', sa.INTEGER(), autoincrement=False, nullable=True),
    sa.Column('employee_id', sa.INTEGER(), autoincrement=False, nullable=True),
    sa.Column('logout_time', postgresql.TIME(), autoincrement=False, nullable=True),
    sa.Column('status', postgresql.ENUM('LATE', 'EARLY', 'PRESENT', 'ABSENT', name='attendancestatus'), autoincrement=False, nullable=True),
    sa.ForeignKeyConstraint(['company_id'], ['companymodel.id'], name='attendancemodel_company_id_fkey', ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['employee_id'], ['employeemodel.id'], name='attendancemodel_employee_id_fkey', ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id', name='attendancemodel_pkey'),
    ...
    sa.Column('id', sa.INTEGER(), autoincrement=True, nullable=False),
    sa.Column('companyid', sa.INTEGER(), autoincrement=False, nullable=True),
    sa.Column('days', postgresql.ENUM('SUNDAY', 'MONDAY', 'TUESDAY', 'WEDNESDAY', 'THURSDAY', 'FRIDAY', 'SATURDAY', name='businessleaveday'), autoincrement=False, nullable=True),
    sa.ForeignKeyConstraint(['companyid'], ['companymodel.id'], name='businessleavedays_companyid_fkey'),
    sa.PrimaryKeyConstraint('id', name='businessleavedays_pkey')
    )
    op.create_index('ix_businessleavedays_id', 'businessleavedays', ['id'], unique=False)
    ...
    sa.Column('employee_id', sa.INTEGER(), autoincrement=False, nullable=True),
    sa.Column('company_id', sa.INTEGER(), autoincrement=False, nullable=True),
    sa.Column('is_invited', sa.BOOLEAN(), autoincrement=False, nullable=True),
    sa.Column('is_accepted', sa.BOOLEAN(), autoincrement=False, nullable=True),
    sa.Column('is_active', sa.BOOLEAN(), autoincrement=False, nullable=True),
    sa.Column('status', postgresql.ENUM('INIT', 'INVITED', 'ACCEPTED', 'REJECTED', name='status'), autoincrement=False, nullable=True),
    sa.ForeignKeyConstraint(['company_id'], ['companymodel.id'], name='employeecompany_company_id_fkey', ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['employee_id'], ['employeemodel.id'], name='employeecompany_employee_id_fkey', ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id', name='employeecompany_pkey')
    )
    ...
    sa.Column('id', sa.INTEGER(), server_default=sa.text("nextval('employeemodel_id_seq'::regclass)"), autoincrement=True, nullable=False),
    sa.Column('name', sa.VARCHAR(), autoincrement=False, nullable=False),
    sa.Column('login_time', postgresql.TIME(), autoincrement=False, nullable=True),
    sa.Column('logout_time', postgresql.TIME(), autoincrement=False, nullable=True),
    sa.Column('salary', postgresql.DOUBLE_PRECISION(precision=53), autoincrement=False, nullable=True),
    sa.Column('duty_time', postgresql.TIME(), autoincrement=False, nullable=True),
    sa.Column('company_id', sa.INTEGER(), autoincrement=False, nullable=True),
    sa.Column('phone', sa.BIGINT(), autoincrement=False, nullable=True),
    sa.Column('is_active', sa.BOOLEAN(), autoincrement=False, nullable=True),
    sa.Column('user_id', sa.INTEGER(), autoincrement=False, nullable=True),
    sa.Column('status', postgresql.ENUM('INIT', 'INVITED', 'ACCEPTED', 'REJECTED', name='status'), autoincrement=False, nullable=True),
    sa.Column('is_approver', sa.BOOLEAN(), autoincrement=False, nullable=True),
    sa.Column('total_sick_leave_taken', sa.INTEGER(), autoincrement=False, nullable=True),
    sa.Column('total_casual_leave_taken', sa.INTEGER(), autoincrement=False, nullable=True),
    sa.ForeignKeyConstraint(['company_id'], ['companymodel.id'], name='employeemodel_company_id_fkey', ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['user_id'], ['attendanceuser.id'], name='employeemodel_user_id_fkey', ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id', name='employeemodel_pkey'),
    ...
    sa.Column('id', sa.INTEGER(), server_default=sa.text("nextval('companymodel_id_seq'::regclass)"), autoincrement=True, nullable=False),
    ...
    sa.Column('is_active', sa.BOOLEAN(), autoincrement=False, nullable=True),
    sa.Column('user_id', sa.INTEGER(), autoincrement=False, nullable=True),
    sa.Column('total_casual_leave_in_year', sa.INTEGER(), autoincrement=False, nullable=True),
    sa.Column('total_sick_leave_in_year', sa.INTEGER(), autoincrement=False, nullable=True),
    sa.Column('created_at', sa.DATE(), autoincrement=False, nullable=True),
    sa.Column('updated_at', sa.DATE(), autoincrement=False, nullable=True),
    sa.ForeignKeyConstraint(['user_id'], ['attendanceuser.id'], name='companymodel_user_id_fkey', ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id', name='companymodel_pkey'),
    sa.UniqueConstraint('name', name='companymodel_name_key'),
    postgresql_ignore_search_path=False
    )
    ...
    sa.ForeignKeyConstraint(['attendance_id'], ['attendancemodel.id'], name='breakmodel_attendance_id_fkey', ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['company_id'], ['employeemodel.id'], name='breakmodel_company_id_fkey', ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id', name='breakmodel_pkey')
    )
    ...
    sa.Column('companyid', sa.INTEGER(), autoincrement=False, nullable=True),
    sa.Column('date', sa.DATE(), autoincrement=False, nullable=True),
    sa.ForeignKeyConstraint(['companyid'], ['companymodel.id'], name='officialholiday_companyid_fkey'),
    sa.PrimaryKeyConstraint('id', name='officialholiday_pkey')
    )
    op.create_index('ix_officialholiday_id', 'officialholiday', ['id'], unique=False)
    ...
    sa.Column('id', sa.INTEGER(), autoincrement=True, nullable=False),
    sa.Column('to', sa.VARCHAR(length=256), autoincrement=False, nullable=True),
    sa.Column('user_id', sa.INTEGER(), autoincrement=False, nullable=True),
    sa.Column('company_id', sa.INTEGER(), autoincrement=False, nullable=True),
    sa.Column('title', sa.VARCHAR(length=256), autoincrement=False, nullable=True),
    sa.Column('desc', sa.VARCHAR(length=256), autoincrement=False, nullable=True),
    sa.Column('subject', sa.VARCHAR(length=256), autoincrement=False, nullable=True),
    sa.ForeignKeyConstraint(['company_id'], ['companymodel.id'], name='notifications_company_id_fkey', ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['user_id'], ['attendanceuser.id'], name='notifications_user_id_fkey', ondelete='CASCADE'),
    ...
    sa.Column('id', sa.INTEGER(), autoincrement=True, nullable=False),
    sa.Column('phone', sa.BIGINT(), autoincrement=False, nullable=True),
    sa.Column('photoUrl', sa.VARCHAR(), autoincrement=False, nullable=True),
    sa.Column('name', sa.VARCHAR(), autoincrement=False, nullable=True),
    sa.Column('is_verified', sa.BOOLEAN(), autoincrement=False, nullable=True),
    sa.Column('is_employer', sa.BOOLEAN(), autoincrement=False, nullable=True),
    sa.Column('email', sa.VARCHAR(length=256), autoincrement=False, nullable=True),
    sa.Column('is_approver', sa.BOOLEAN(), autoincrement=False, nullable=True),
    sa.Column('dob', sa.DATE(), autoincrement=False, nullable=True),
    sa.Column('fcm_token', sa.VARCHAR(length=256), autoincrement=False, nullable=True),
    sa.PrimaryKeyConstraint('id', name='attendanceuser_pkey'),
    sa.UniqueConstraint('phone', name='attendanceuser_phone_key')
    )
