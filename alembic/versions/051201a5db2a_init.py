...
Revision ID: 051201a5db2a
Revises: 
Create Date: 2023-08-20 23:43:35.708488
...
def upgrade() -> None:
    ...
    # op.drop_index('ix_attendancemodel_id', table_name='attendancemodel')
    ...
    # op.drop_index('ix_employeemodel_id', table_name='employeemodel')
    ...
    # op.drop_index('ix_employeecompany_id', table_name='employeecompany')
    # op.drop_table('employeecompany')
    # op.drop_index('ix_companymodel_id', table_name='companymodel')
    # op.drop_table('companymodel')
    # op.drop_index('ix_book_id', table_name='book')
    # op.drop_table('book')
    # op.drop_table('foreignexchange')
    # op.drop_index('ix_attendanceuser_id', table_name='attendanceuser')
    ...
    # op.drop_index('ix_leaverequest_id', table_name='leaverequest')
    ...
    # op.drop_index('ix_breakmodel_id', table_name='breakmodel')
    ...
    op.create_foreign_key(None, 'recivingmethod', 'recipient', ['recipient_id'], ['id'])
    op.add_column('remituser', sa.Column('fcm_token', sqlmodel.sql.sqltypes.AutoString(), nullable=True))
    op.add_column('remituser', sa.Column('refrence_id', sa.Integer(), nullable=True))
    op.create_foreign_key(None, 'transaction', 'recivingmethod', ['reciving_method'], ['id'])
...
def downgrade() -> None:
    ...
    op.drop_column('remituser', 'fcm_token')
    op.drop_constraint(None, 'recivingmethod', type_='foreignkey')
    ...
    sa.Column('id', sa.INTEGER(), server_default=sa.text("nextval('attendanceuser_id_seq'::regclass)"), autoincrement=True, nullable=False),
