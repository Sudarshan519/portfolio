...
Revision ID: 49755a10098d
Revises: 
Create Date: 2023-08-22 17:01:26.155421
...
def upgrade() -> None:
    ...
    sa.Column('to', sa.String(length=256), nullable=True),
...
def downgrade() -> None:
    ...
    sa.Column('id', sa.INTEGER(), server_default=sa.text("nextval('recipient_id_seq'::regclass)"), autoincrement=True, nullable=False),
