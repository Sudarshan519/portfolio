...
Revision ID: 8fb2d0b7f4cc
Revises: 49755a10098d
Create Date: 2023-08-22 21:09:33.242432
...
revision = '8fb2d0b7f4cc'
down_revision = '49755a10098d'
branch_labels = None
depends_on = None
...
def upgrade() -> None:
    ...
    op.add_column('companymodel', sa.Column('created_at', sa.Date(), nullable=True))
    op.add_column('companymodel', sa.Column('updated_at', sa.Date(), nullable=True))
    # ### end Alembic commands ###


def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_column('companymodel', 'updated_at')
    op.drop_column('companymodel', 'created_at')
    ...
    sa.Column('id', sa.INTEGER(), server_default=sa.text("nextval('recivingmethod_id_seq'::regclass)"), autoincrement=True, nullable=False),
